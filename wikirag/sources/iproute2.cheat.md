---
nom: iproute2.cheat
description: Cheatsheet navi complet iproute2 — liens, routes, netns, vlan, macvlan, ipvlan, policy routing
type: source
...
# Source : iproute2.cheat

> Cheatsheet navi original de pushou, catégorisé `category:network`.

## Description

Fichier de cheatsheet navi le plus complet du dépôt, couvrant l'ensemble de la suite iproute2 : gestion des interfaces, routes, namespaces, VLAN, macvlan, ipvlan, macvtap, interfaces dummy, et policy routing.

## Métadonnées

| Champ | Valeur |
|-------|--------|
| Fichier | `sources/iproute2.cheat` |
| Auteur | pushou |
| Tags | `iproute2, ip, network, networking, category:network` |
| Sections | 7+ (liens, interfaces virtuelles, netns, policy routing, monitoring) |
| Type | Cheatsheet navi |

## Pages wiki alimentées

- [[entites/iproute2.md]] — Page d'entité iproute2
- [[concepts/network-namespaces.md]] — Concept des namespaces réseau
- [[concepts/policy-routing.md]] — Concept de policy routing
- [[concepts/interfaces-virtuelles.md]] — Concept macvlan, ipvlan, veth, dummy

## Contenu brut

```
% iproute2,ip,network,networking,category:network,pushou
