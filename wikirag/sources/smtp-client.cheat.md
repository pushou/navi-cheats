---
nom: smtp-client.cheat
description: Cheatsheet navi de gestion SMTP — Postfix, TLS, swaks, Docker macvlan
type: source
...
# Source : smtp-client.cheat

> Cheatsheet navi original de pushou, catégorisé `category:network`.

## Description

Fichier de cheatsheet navi contenant des commandes de gestion de serveur SMTP (Postfix), vérification TLS, gestion de la file d'attente, envoi de test avec `swaks`, et déploiement Docker avec macvlan.

## Métadonnées

| Champ | Valeur |
|-------|--------|
| Fichier | `sources/smtp-client.cheat` |
| Auteur | pushou |
| Tags | `smtp-client, smtp, postfix, email, network, category:network` |
| Sections | 6 |
| Type | Cheatsheet navi |

## Pages wiki alimentées

- [[entites/postfix.md]] — Page d'entité Postfix
- [[entites/swaks.md]] — Page d'entité swaks

## Contenu brut

```
% smtp-client,smtp,postfix,email,network,category:network,pushou
